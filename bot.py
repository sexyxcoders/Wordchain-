    ...
    if not await check_membership(client, user_id):
        ...
        try:
            await message.reply_photo(
                ...
                caption=("⚠️ <b>ʏᴏᴜ ᴍᴜꜱᴛ ᴊᴏɪɴ ʙᴏᴛʜ ᴄʜᴀɴɴᴇʟꜱ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ.</b>\n\n"
                         "📢 @Sxnpe\n📢 @TechNodeCoders\n\n"
            ...
            await message.reply_text(
                "⚠️ ʏᴏᴜ ᴍᴜꜱᴛ ᴊᴏɪɴ @Sxnpe & @TechNodeCoders ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ.",
                reply_markup=buttons,
                parse_mode=ParseMode.HTML
            )
        return
...
async def recheck_membership(client, callback_query):
    ...
    if await check_membership(client, user_id):
        ...
        await callback_query.answer("❌ ᴘʟᴇᴀꜱᴇ ᴊᴏɪɴ ʙᴏᴛʜ @Sxnpe & @TechNodeCoders ꜰɪʀꜱᴛ.", show_alert=True)
...
async def connect_cmd(client, message):
    ...
    if len(args) < 2:
        await message.reply_text("⚠️ ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ʏᴏᴜʀ ᴛᴇʟᴇᴛʜᴏɴ ꜱᴛʀɪɴɢꜱᴇꜱꜱɪᴏɴ ᴀꜰᴛᴇʀ /connect.", parse_mode=ParseMode.HTML)
        return
...
async def disconnect_cmd(client, message):
    ...
    if user_id == config.OWNER_ID and len(args) > 1:
        target = int(args[1])
